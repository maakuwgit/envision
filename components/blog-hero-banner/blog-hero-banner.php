...
<div class="ll-blog-hero-banner hdg relative<?php echo implode( " ", $classes ); ?>"<?php echo ' id="'.$id.'"'; ?> data-component="blog-hero-banner"<?php echo $bg; ?>>

  <?php if( $image ) : ?>
    <div class="blog-hero-banner__feature feature">
...
<?php endif; ?>
  ...
  <?php if( $heading ) : ?>
    ...
    <<?php echo $heading_tag; ?> class="blog-hero__heading hdg__heading col col-md-8of12 col-lg-8of12 col-xl-9of12">
      <?php echo $heading; ?>
  ...
  <?php if ( $subheading ) : ?>
    ...
    <<?php echo $subheading_tag; ?> class="blog-hero__subheading hdg__subheading col col-md-8of12 col-lg-9of12 col-xl-8of12">
      <?php echo $subheading; ?>
